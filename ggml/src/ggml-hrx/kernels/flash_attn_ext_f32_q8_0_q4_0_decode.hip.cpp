...
struct hrx_flash_attn_ext_f32_q8_0_q4_0_decode_constants {
    long long D;
    long long KV;
    long long N;
    long long H;
...
static __device__ __forceinline__ float hrx_alibi_slope(
        const hrx_flash_attn_ext_f32_q8_0_q4_0_decode_constants c,
        long long head) {
    if (c.max_bias <= 0.0f) {
        return 1.0f;
    }
...
extern "C" __global__ void hrx_flash_attn_ext_f32_q8_0_q4_0_decode(
        const float * q, const hrx_block_q8_0 * k, const hrx_block_q4_0 * v,
        const __half * mask, const float * sinks, float * dst,
        hrx_flash_attn_ext_f32_q8_0_q4_0_decode_constants c) {
